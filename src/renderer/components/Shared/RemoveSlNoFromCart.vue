...
export default {
  ...
  methods: {
    ...
    SearchInStock (SlNo) {
      switch (this.WhereFrom) {
        case 0:
          this.$store.dispatch('Sales/decrementingProductSlNoFromCart', SlNo)
          this.dialog = false
          this.$router.push('/createinvoice')
          break
        case 1:
          this.$store.dispatch('Transfers/decrementingProductSlNoFromCart', SlNo)
          this.dialog = false
          this.$router.push('/createtransfer')
          break
        case 2:
          this.$store.dispatch('Returns/decrementingProductSlNoFromCart', SlNo)
          this.dialog = false
          this.$router.push('/createreturn')
          break
      }
